...
---
ui:
    wrapper: relative h-full bg-oma-cyan-50 dark:bg-neutral-500 rounded-2xl shadow-xl
---
    :::ShSegment
    ---
    ui:
    ...
    ---
        ...
        ---
            ...
            ---
            ui:
                wrapper: p-2 mt-52 rounded-xl bg-white opacity-[70%] text-oma-red-400 font-extrabold text-center
            ---
    ...
    ---
    ui:
        wrapper: -ml-9 pl-8 pr-8 pt-24
    ---
    The next OMA Test Event **SVE-42** will take place in [Dusseldorf, Germany, October 28 - 31, 2024]{.text-black .dark:text-golden}.
    Register by following these two simple steps:
    - [Register Your Implementation & Team]{.text-black .dark:text-golden}
    - [Pay $200 per each team participant]{.text-black .dark:text-golden} [(at the venue or remote)]{.italic .text-black .dark:text-golden}

    ::::ShButton
    ---
    ui:
        wrapper: bg-oma-red-400 mt-6 flex mx-auto w-fit
