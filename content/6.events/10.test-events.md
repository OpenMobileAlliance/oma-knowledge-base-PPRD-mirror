...
---
    ...
    ---
    The next OMA Test Event **SVE-42** will take place in [Dusseldorf, Germany, October 28 - 31, 2024]{.text-black}.
    ...
    ui:
        wrapper: pt-44
    ---
    <em>[Note: At this event there is no charge per implementation.]{.bg-gray-200 .border-l-4 .border-gray-400 .p-2 .pl-9 .pr-9}</em>
    ::::
    :::
::
