...
---
ui:
    wrapper: rounded-3xl border-8 border-oma-red-500 animate-[pulseBorderSaturation_2s_infinite]
---
    :::ShSegment
    ---
    ui:
        wrapper: p-32 rounded-2xl
    ...
    ---
        ...
        ---
        ui:
            wrapper: p-8 rounded-lg bg-gradient-to-b opacity-[80%] from-white text-black
        ---
        The next OMA Test Event [SVE-42]{.text-black} will take place in [Dusseldorf, Germany, October 28 - 31, 2024]{.text-black}.

        Register by following these two simple steps:
        - [Register Your Implementation & Team]{.text-black}
        - [Pay $200 per each team participant]{.text-black} [(at the venue or remote)]{.italic .text-black}

        > Note: At this event there is no charge per implementation.
        ::::
    :::
    
<style>
@keyframes pulseBorderSaturation {
  0%, 100% { border-color: hsl(0, 100%, 50%); }
...
The next OMA Test Event **SVE-42** will take place in Dusseldorf, **Germany, October 28 - 31, 2024**.

Register by following these two simple steps:
* Register Your Implementation & Team
* Pay $200 per each team participant (_at the venue or remote_)
...
> Note: At this event there is no charge per implementation.
    ...
    Step 1: Register Your Implementation & Team  
    :::
    ...
    Step 2: Pay for Your Registration 
    :::

<figure>
    <img src="/images/utilities/utilities-2.png" alt="OMA Test Event">
</figure>

This event is designed to achieve a number of goals, including:
