...
---
    ...
    ---
        ...
        ---
        ui:
            wrapper: p-24 rounded-xl max-h-max bg-white opacity-[8%]
   ...
   [⚠️ ATTENTION:]{ class="text-3xl mx-auto"} 

   
   Due to scheduling challenges and planning priorities, the [October OMA Test Event]{class="text-blue-600"} will be **postponed** to **Q1 2025**.
   
   [We send out apologies]{class="text-blue-600 font-semibold"}!
