...
# OMA TEST EVENT SVE-44 Krakow, Poland - April 20-23, 2026
...
## Opening of Registration: OMA LwM2M Test Event (SVE-44)
...
OMA TestFest is a confidential and secure, multi-vendor interoperability testing event. Participants use Client and/or Server implementations of OMA protocols (LwM2M for this event) for structured cross-vendor testing.

OMA will provide official test cases and publish aggregate (non-attributed) test results. Participants may optionally publish their individual implementation test results on the OMA Product Listing site.
