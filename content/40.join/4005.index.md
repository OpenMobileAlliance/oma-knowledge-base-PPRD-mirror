...
---
    ...
    ui:
      teaser:
    layout: teaser
    coverImage: /images/join/join-part-6.jpg
    icon: mdi:water-pump
    urlWrapper: /join/utility
    title: |
         UTILITY MEMBERSHIP
    subtitle: |
        For Water Utilities
    text: |
         💧 **Water utilities**: join OMA and help shape the **Water 2.0** interoperability profile
    ---
    :::
...
::ShAlert
**Water utilities**: investor-owned and other regulated water utilities should use the dedicated [Utility Membership](/join/utility) application instead, with the first-year fee fully waived.
::
