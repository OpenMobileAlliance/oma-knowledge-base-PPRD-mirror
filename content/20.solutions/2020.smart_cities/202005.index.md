...
---
    ...
    layout: teaser
    icon: mdi:handshake-outline
    urlWrapper: /specifications/resources/lwm2m-client-conformance-tool
    title: |
        New Conformance Tool
    subtitle: |
        Validate Your Implementation for Free
    text: |
        Test your LwM2M Client against OMA's conformance tool — now open for beta testers
    ---
    :::
