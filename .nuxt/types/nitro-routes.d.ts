...
declare module 'nitropack' {
  ...
  interface InternalApi {
    ...
    '/api/tweets/:id': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../node_modules/nuxt-testimonial/dist/runtime/server/api/tweets/[id].get').default>>>>
    }
    ...
    '/api/_content/cache.1726952119628.json': {
