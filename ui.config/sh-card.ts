export default {
  wrapper: "flex flex-col justify-between border-2 border-[#D2D9E0] hover:border-4 rounded-xl mx-auto max-w-lg bg-white dark:bg-black overflow-hidden shadow-2xl",
