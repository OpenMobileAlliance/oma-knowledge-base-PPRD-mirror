export default {
  ...
  header: "",
  title: "pt-6 text-3xl font-extrabold text-center dark:text-primary",
  subtitle: "pb-6 text-xl font-semibold text-gray-600 dark:text-neutral-500 -mt-8 text-center",
  text: "pb-16 text-center font-light dark:text-golden",
