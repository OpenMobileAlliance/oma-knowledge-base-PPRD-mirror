export default {
  wrapper: "pl-4 pr-4 pb-10 shadow-xl bg-sky-100 dark:bg-oma-blue-950 rounded-2xl",
  inner: "",
  tags: {
    ...
    list: "inline-block overflow-hidden hover:scale-105 duration-200 ease-in-out rounded-3xl text-lg cursor-pointer px-3 mx-2 mt-4 hover:shadow-xl hover:shadow-[#8DD1C3] border border-green-800 dark:text-white dark:border-oma-cyan-700 dark:shadow-oma-cyan-300",
  },
  header: "",
