export default {
  ...
  header: "",
  title: "title pt-6 text-3xl font-extrabold text-center dark:text-primary",
  subtitle: "subtitle pb-6 text-xl font-semibold text-gray-600 dark:text-neutral-500 -mt-8 text-center",
  text: "text pb-16 text-center font-light dark:text-golden",
