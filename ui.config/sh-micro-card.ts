export default {
    wrapper: "grid grid-row-3 grid-flow-row rounded-2xl shadow-lg max-w-lg max-h-lg p-4 mx-auto justify-items-center text-center hover:scale-105 duration-300",
