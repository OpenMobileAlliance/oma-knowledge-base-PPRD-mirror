export default {
    wrapper: "grid grid-row-3 grid-flow-row rounded-2xl max-w-lg max-h-lg p-4 mx-auto justify-items-center text-center hover:scale-105 duration-300 bg-white border-2 border-primary-50 dark:bg-zinc-800 hover:border-primary dark:border-neutral-500 dark:hover:border-primary",
