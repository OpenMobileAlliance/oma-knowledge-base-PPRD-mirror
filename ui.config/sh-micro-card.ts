export default {
    wrapper: "grid grid-row-3 grid-flow-row border-2 rounded-2xl shadow-lg bg-red-100 max-w-lg max-h-lg p-4 mx-auto justify-items-center text-center hover:scale-105 duration-300",
